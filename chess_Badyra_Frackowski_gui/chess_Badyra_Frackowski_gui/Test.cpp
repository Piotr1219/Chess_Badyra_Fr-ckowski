...
void CorrectnessTest::RunAllCorrectnessTests()
{
	TestBlankBoard();
...
//[Test]
void CorrectnessTest::TestBlankBoard()
{
	Board board = Board();
...
//[Test]
void CorrectnessTest::TestStandardBoardShortFEN()
{
...
//[Test]
void CorrectnessTest::TestStandardBoardFullFEN()
{
...
//[Test]
void CorrectnessTest::TestBoardOrientation()
{
	string standardFen = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1";
	Board board = Board(standardFen);
...
//[Test]
void CorrectnessTest::TestValidMoves()
{
...
//[Test]
void CorrectnessTest::TestSimpleMoves()
{
	string standardFen = "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1";
...
//[Test]
void CorrectnessTest::Test50MoveRule() {
...
//[Test]
void CorrectnessTest::TestRealGame() {
	/*
...
ChessPieceColor PerformanceTest::GetOppositeColor(ChessPieceColor color)
{
	return color == ChessPieceColor::Black ? ChessPieceColor::White : ChessPieceColor::Black;
}

int PerformanceTest::SideToMoveScore(int score, ChessPieceColor color)
{
...
PerformanceTest::PerformanceResult PerformanceTest::RunPerfTest(int depth, Board board)
{
...
long PerformanceTest::Performance(int depth, Board board, ChessPieceColor color)
{
	long nodes = 0;
...
ResultBoards PerformanceTest::GetPossibleBoards(ChessPieceColor movingSide, Board examineBoard)
{
